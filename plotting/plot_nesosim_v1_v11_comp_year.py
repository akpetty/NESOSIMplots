...
reanalysis='ERAI'
folderStr=reanalysis+'sfERAIwindsOSISAFdriftsCDRsicrhovariable_IC2_DYN1_WP1_LL1_WPF5.8e-07_WPT5_LLF2.9e-07-100kmv11ng'
...
cb.set_label('snow depth (m)',size=8)
...
cb2.set_label('snow depth (m)',size=8)
...
cb3.set_label('difference(m)',size=8)

# Show

plt.savefig(figure_path+'/Model/v1_v11'+dateOut[-8:]+folderStr+'.png', dpi=300)
